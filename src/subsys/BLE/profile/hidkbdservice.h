...
#define HID_RPT_ID_MOUSE_IN         6  // Mouse input report ID
#define HID_RPT_ID_LED_OUT          1  // LED output report ID
#define HID_RPT_ID_FEATURE          1  // Feature report ID
#define HID_RPT_ID_KEYBIT_IN        3
#define HID_RPT_ID_KEYCONSUME_IN    5  // Consumer input report ID  ²»ÒªÓÃid4
#define HID_RPT_ID_HIDx_IN          2
#define HID_RPT_ID_SYS_IN           7
 ...
 * @return  GATT status code.
 */
extern uint8 Hid_GetParameter(uint8 id, uint8 type, uint16 uuid, uint16 *pLen,
        void *pValue);
